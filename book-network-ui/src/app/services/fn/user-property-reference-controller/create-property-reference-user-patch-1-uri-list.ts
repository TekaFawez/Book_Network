...
export function createPropertyReferenceUserPatch1$UriList(http: HttpClient, rootUrl: string, params: CreatePropertyReferenceUserPatch1$UriList$Params, context?: HttpContext): Observable<StrictHttpResponse<CollectionModelBookTransactionHistory>> {
...
createPropertyReferenceUserPatch1$UriList.PATH = '/users/{id}/histories';
